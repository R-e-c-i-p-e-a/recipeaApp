const search = (ev) => {
  ...
  document.querySelector('#output').innerHTML = 'Loading...';
    let url = 'http://api.edamam.com/search?q=' + document.querySelector('input').value + '&app_id=23554e52&app_key=56161b12b3928966226de685a1d07b2c&from=0&to=3&calories=591-722&health=alcohol-free';
